<?php
/* Smarty version 3.1.36, created on 2023-11-16 07:56:25
  from 'C:\xampp\htdocs\whmcs\templates\first-them\includes\head.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_6555bd19b87ec5_27185622',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'bfbf97d44d3ab7e170c815360061a4c0494edafd' => 
    array (
      0 => 'C:\\xampp\\htdocs\\whmcs\\templates\\first-them\\includes\\head.tpl',
      1 => 1700117535,
      2 => 'file',
    ),
  ),
...
function content_6555bd19b87ec5_27185622 (Smarty_Internal_Template $_smarty_tpl) {
?><!-- Styling -->
...
<?php $_block_plugin2 = isset($_smarty_tpl->smarty->registered_plugins['block']['assetExists'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['assetExists'][0][0] : null;
if (!is_callable(array($_block_plugin2, 'assetExists'))) {
throw new SmartyException('block tag \'assetExists\' not callable or registered');
}
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('assetExists', array('file'=>"nav.css"));
$_block_repeat=true;
echo $_block_plugin2::assetExists(array('file'=>"nav.css"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
<link href="<?php echo $_smarty_tpl->tpl_vars['__assetPath__']->value;?>
" rel="stylesheet">
<?php $_block_repeat=false;
echo $_block_plugin2::assetExists(array('file'=>"nav.css"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
>
<?php echo '<script'; ?>
 src="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['assetPath'][0], array( array('file'=>'my.js'),$_smarty_tpl ) );?>
?v=<?php echo $_smarty_tpl->tpl_vars['versionHash']->value;?>
"><?php echo '</script'; ?>
>
