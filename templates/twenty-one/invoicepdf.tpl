...
// $invoiceId = $id;
// }
// $InvoiceData = Capsule::table('currency_rate')
...
$pdf->MultiCell( 100, 5, Lang::trans( 'invoicesnotes' ) . ': ' . 'Here is invoice genrated according price exchange term and condition' );
if ( $notes ) {
    $pdf->Ln( 5 );
    $pdf->SetFont( $pdfFont, '', 8 );
