    ...
    <div class="container-fluid invoice-container">
        ...
        {else}
            ...
            {if $notes}
                ...
                {/if}
                {include file="$template/includes/panel.tpl" type="info" headerTitle="{lang key='invoicesnotes'}" bodyContent='Here is invoice genrated according price exchange term and condition'}
