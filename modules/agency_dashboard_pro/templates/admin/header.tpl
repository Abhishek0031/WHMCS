  ...
  <script src="..\modules\addons\agency_dashboard_pro\templates\admin\js\ajax.js"></script>
<div class="lisence-verify-wrapper">
    <div class="lisence-verify-header">
        ...
        <div class="right-lisence-verify">
            <a href="addonmodules.php?module=agency_dashboard_pro" class="border-right-lis">Dashboard</a>
            <a href="addonmodules.php?module=agency_dashboard_pro&action=productlist" class="border-right-lis">Product Listing</a>
