...
namespace WHMCS\Module\Addon\exchange_currency\Admin;
...
class Controller {
    ...
    public function __construct()
    {
        ...
        $this->tplVar['tplDIR'] = ROOTDIR . "/modules/addons/exchange_currency/templates/admin/";
        $this->tplVar['jsonData'] = ROOTDIR . "/resources/country/dist.countries.json";
        $this->tplVar['imgPath'] = $CONFIG["SystemURL"] . "/modules/addons/exchange_currency/assets/image/wgs-logo.svg";
    ...
    // }
    // $custumData = Capsule::table('exchange_currency')->get();
