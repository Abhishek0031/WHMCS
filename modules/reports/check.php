                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group date-picker-prepend-icon">
                            ...
                            <input id="dueDate" type="text" name="dueDate" value="{$range}" class="form-control date-picker-search date-picker-search-100pc" placeholder="{$langRequired}"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="form-group date-picker-prepend-icon">
                            ...
                            <input id="paidD" type="text" name="paidD" value="{$range}" class="form-control date-picker-search date-picker-search-100pc" placeholder="{$langRequired}"/>
                        </div>
                    </div>
                </div>
            </div>
